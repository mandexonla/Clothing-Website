					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0901142097</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> nguyendangman0309@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
                                <li><a href="https://www.facebook.com/dangman1504"><i class="fa fa-facebook"></i></a></li>
    		...
    		<div class="row" style="margin-top: 100px;">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>E-SHOPPER</p>
							<p>Hải Châu - TP Đà Nẵng - Việt Nam</p>
							<p>Số Điện thoại: 0901142097</p>
							<p>Email: nguyendangman0309@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
